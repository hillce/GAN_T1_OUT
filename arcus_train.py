...
datasetTrain = T1_Train_Dataset(fileDir=fileDir,t1MapDir=t1MapDir,size=20000,transform=trnsInTrain,load=load)
...
for nE in range(numEpochs):
    ...
    for i,data in enumerate(loaderTrain):
        ...
        writer.add_scalars('Loss/train',err1.item(),trainLossCnt)
